...
class Paddle:
    ...
    def move(self, enemy_Rectf, ball_Rectf, table_size):
        ...
        # the program crashes if move_getter crashes if the runtime of move_getter is not limited
        direction = self.move_getter.pong_ai(self.Rectf.copy(), enemy_Rectf.copy(), ball_Rectf.copy())
        
        # the program continues if move_getter crashes, The runtime of move_getter is limited
    ...
    def move(self, paddles, table_size, move_factor):
        ...
        for paddle in paddles:
            if self.Rectf.intersect(paddle.Rectf):
                ...
                #prevent multiple bounces from accelerating the ball too much
